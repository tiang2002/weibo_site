...
def index(request):
    ...
    num = json.dumps(num)
    with open(PROJECT_ROOT + r'\weibo\templates\weibo\css\style.css', 'r', encoding='utf-8') as file:
        css = file.read()
    with open(PROJECT_ROOT + r'\weibo\templates\weibo\js\echarts.min.js', 'r', encoding='utf-8') as file:
        js = file.read()
